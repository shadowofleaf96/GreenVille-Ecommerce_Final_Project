...
const SingleProduct = () => {
  ...
  const buyNow = () => {
    ...
    if (product?.variants?.length > 0) {
      if (getSelectedCount() > 0) router.push("/cart");
        ...
        <motion.div {...fadeInUp} className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-16 items-start">
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="relative aspect-square bg-gray-50/50 rounded-3xl sm:rounded-[3rem] p-4 sm:p-10 flex items-center justify-center border border-gray-200 shadow-inner overflow-hidden group mx-auto">
