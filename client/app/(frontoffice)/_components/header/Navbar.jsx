...
} from "@/store/slices/shop/customerSlice";
                ...
                >
                  ...
                  {cartCount > 0 && (
                    <span
                      ...
                      className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] sm:text-xs font-black w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center rounded-full border-2 border-white shadow-lg pulse-animation"
                    >
                      {cartCount}
                    </span>
                  )}
