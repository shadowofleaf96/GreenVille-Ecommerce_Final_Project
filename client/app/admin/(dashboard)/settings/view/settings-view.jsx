...
export default function SettingsView() {
  ...
  useEffect(() => {
    if (settingsData) {
      const formData = {
        ...
        vendor_config:
          settingsData.vendor_config || getDefaultSettings().vendor_config,
  ...
  const onSubmit = async (data) => {
    ...
    formData.append("vendor_config", JSON.stringify(data.vendor_config || {}));
  ...
  const searchSections = useMemo(
    () => [
      ...
      {
        id: "vendor",
        title: t("Vendor Configuration"),
        description: t("Enable or disable vendor features"),
        onClick: () => {
          setActiveTab("ecommerce");
  ...
  return (
    <motion.div
      ...
      initial="initial"
      animate="animate"
      className="w-full px-4 sm:px-6 lg:px-12 py-8 max-w-400 mx-auto"
    >
      {/* Header */}
      <motion.div
        variants={fadeInUp}
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        {/* Sidebar Navigation */}
        <motion.aside variants={fadeInUp} className="lg:w-72 xl:w-80 shrink-0">
              ...
              {activeTab === "general" && (
                ...
                >
                  ...
                  <SectionCard
                    ...
                    description={t("Select fonts for your website")}
                    isOpen={expandedSection === "typography"}
                    onToggleCollapse={() => toggleSection("typography")}
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <Controller
                        name="theme.primary_font"
                        control={control}
                        render={({ field }) => (
                          <div className="space-y-2">
                            <Label className="text-sm font-bold text-gray-800">
                      ...
                      <Controller
                        name="theme.secondary_font"
                        control={control}
                        render={({ field }) => (
                          <div className="space-y-2">
                            <Label className="text-sm font-bold text-gray-800">
                              {t("Heading Font (Secondary)")}
                            </Label>
                            <Select
                              onValueChange={field.onChange}
                              value={field.value || "Raleway"}
                        ...
                        (policyKey) => (
                          ...
                          >
                            ...
                            <MultilingualInput
                              ...
                              multiline
                              disabled={
                                !watch(`policies.${policyKey}.isActive`)
                              }
                            />
                          </div>
                        ),
              ...
              {activeTab === "ecommerce" && (
                ...
                >
                  ...
                  <SectionCard
                    title={t("Vendor Configuration")}
                    description={t(
                      "Manage multi-vendor features on your store",
                    )}
                    isOpen={expandedSection === "vendor"}
                    onToggleCollapse={() => toggleSection("vendor")}
                  >
                    <div className="space-y-6">
                      <div className="flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-dashed border-gray-200">
                        <div className="space-y-1">
                          <Label className="text-base font-bold text-gray-800 tracking-tight">
                            {t("Enable Vendor Feature")}
                          </Label>
                          <p className="text-xs text-gray-500 font-medium">
                            {t(
                              "When enabled, vendor names will be displayed on product cards and single product pages.",
                            )}
                          </p>
                        </div>
                        <Controller
                          name="vendor_config.isActive"
                          control={control}
                          render={({ field }) => (
                            <div className="flex items-center space-x-3">
                              <Switch
