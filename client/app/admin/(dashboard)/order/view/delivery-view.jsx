...
import { setData, setLoading, setError } from "@/store/slices/admin/orderSlice";
...
import OrderMap from "@/components/shared/map/OrderMap";
...
export default function DeliveryView() {
  ...
  return (
    <motion.div
      ...
      initial="initial"
      animate="animate"
      className="w-full px-4 sm:px-6 lg:px-8 py-10 space-y-10"
    >
