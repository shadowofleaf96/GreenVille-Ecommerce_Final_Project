...
export default function ProductTableHead({
  ...
  return (
    <TableHeader className="bg-gray-50/50 border-y border-gray-100 font-bold">
      <TableRow className="hover:bg-transparent">
        ...
        {headLabel.map((headCell) => (
          <TableHead
            key={headCell.id}
            className="p-4 font-bold text-gray-600 uppercase tracking-wider text-xs select-none"
